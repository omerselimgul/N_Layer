    ...
    public class InMemoryProductDal : IProductDao
    {
        ...
        public InMemoryProductDal()
        {
            _products = new List<Product>
            {
                ...
                new Product{ProductId=2,CategoryId=1,ProductName="Telefon",UnitsInStock=2,UnitPrice=1500},
                new Product{ProductId=3,CategoryId=2,ProductName="Kamera",UnitsInStock=3,UnitPrice=500},
